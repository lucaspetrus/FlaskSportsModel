...
def create_db():
    # TODO: Add comments breaking out the cleaning of the csv for creating the database

    cmd = 'pwd'
    os.system(cmd)
    df = pd.read_csv('FlaskSports/Data/data.csv')
    ...
    conn = sqlite3.connect('FlaskSports/Data/bbstats.sqlite3')
